...
const Hero = () => {
    return (
        <section id='hero' className="sm:h-full xl:h-lvh">
            <article className="text-center flex flex-col items-center mx-auto w-2/3  my-4">
                <h1 className="sm:text-3xl text-xl font-black animate-slidein">Great futures are built with a small charity</h1>
