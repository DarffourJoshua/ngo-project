    ...
    return (
        <article className="hidden sm:grid xl:grid-cols-5 sm:grid-cols-4 sm:gap-2 sm:m-10 ">
            <div className="text-white">
               <Description className={'bg-emerald-900 rounded-xl sm:pt-4 px-2 pb-1 sm:h-auto xl:h-80 flex flex-col justify-between gap-2 mb-4 hover:-skew-y-12'}>
                ...
                <Description className={"flex items-center p-2 bg-gray-900  rounded-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 sm:translate-y-4"}>       
            ...
            <Description className={'bg-[#0f766e] flex flex-col justify-between rounded-xl gap-20 pt-2 pl-2 h-auto w-auto text-white translate-y-4 transition-all ease-in-out delay-700 duration-700 hover:-scale-100 hover:-translate-y-12'}>
            ...
            <Description className={'bg-[#a3e635] rounded-xl hidden xl:block xl:translate-y-72 h-32 transition ease-in-out delay-700 hover:-translate-y-4 hover:scale-100 duration-700  flex flex-col'}>
                ...
                <Button 
                    ...
                    style={'flex items-center gap-4 bg-gray-400 py-2 px-1 rounded-xl mx-auto text-xs'}
                />
            </Description>
            <Description className={'bg-[#0d9488] flex flex-col justify-between rounded-xl pl-3 pt-3 h-auto translate-y-4 text-white transition-all ease-in-out delay-700 duration-700 hover:-scale-100 hover:-translate-y-12'}>
            ...
            <div className="flex flex-col justify-between">
               <Description className={'bg-lime-500 rounded-xl py-4 sm:h-60 xl:h-3/4 flex flex-col justify-between hover:skew-y-12'}>
